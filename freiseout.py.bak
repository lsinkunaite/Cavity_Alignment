...
def run(noplot=None):
	...
	if (noplot==None):
		...
		trace1=ax1.plot(x, y[:,0], '-', color = next(colorcycler), label = 'pow n3 : ')
		trace2=ax1.plot(x, y[:,1], '-', color = next(colorcycler), label = 'ad00 n3 : ')
		trace3=ax1.plot(x, y[:,2], '-', color = next(colorcycler), label = 'ad10 n3 : ')
		trace4=ax1.plot(x, y[:,3], '-', color = next(colorcycler), label = 'ad01 n3 : ')
		trace5=ax1.plot(x, y[:,4], '-', color = next(colorcycler), label = 'ad20 n3 : ')
		trace6=ax1.plot(x, y[:,5], '-', color = next(colorcycler), label = 'ad11 n3 : ')
		trace7=ax1.plot(x, y[:,6], '-', color = next(colorcycler), label = 'ad02 n3 : ')
