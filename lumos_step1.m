...
finesse_filename='freise_step1'; % Finesse filename w/o extension
...
for L = L_from:L_step:L_to
    ...
    %HG_modes_plot(xvar,totalpower,maxTEM,powerMatrix,theta_from0,theta_to0);
...
power_distance_plot(maxTEM,L_to,L_from,L_step,xvar_L,power_L,fitting_legend_string,theta_from0,theta_to0);
